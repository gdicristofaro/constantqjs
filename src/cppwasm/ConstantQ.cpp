...
namespace constantq
{
    SparseKernel ConstantQ::sparseKernel(
        size_t fs, double minFreq, double maxFreq, size_t bins, double thresh)
    {
        ...
        SparseKernel sparKernel)
    {
        ...
        for (size_t b = 0; b < binSize; b++)
        {
            ...
            for (size_t e = 0; e < sparKernelSize; e++)
            {
