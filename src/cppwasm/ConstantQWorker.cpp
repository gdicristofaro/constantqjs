...
extern "C"
{
    ...
    void initializeSession(char *charData, int size)
    {
        ...
        EM_ASM({ console.log('initializeSession: fs', $0,
                             ...
                             'thresh', $4,
                             'bins', $5,
                             'size', $6); }, fs, minFreq, maxFreq, bins, thresh, retArgs.bins, retArgs.size);
#endif
    ...
    void sessionAnalyze(char *charData, int size)
    {
        ...
        EM_ASM({ console.log('sessionAnalyze: startFrame', $0,
                             ...
                             'totLen', $5,
                             'bins', $6,
                             'sparse kernel size', $7); }, startFrame, frameInterval, totalSamples, sampleStart, arrSize, totLen, curSession.value().bins(), curSession.value().size());
