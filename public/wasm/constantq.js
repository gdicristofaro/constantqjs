...
var wasmBinaryFile = 'constantq.wasm';
...
function nullFunc_viddidiiiii(x) {
  err(
    "Invalid function pointer called with signature 'viddidiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)",
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiddidiiiii(x) {
  err(
    "Invalid function pointer called with signature 'viiddidiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)",
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiid(x) {
  err(
    "Invalid function pointer called with signature 'viiid'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)",
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function jsCall_iiiid(index, a1, a2, a3, a4) {
...
function jsCall_viddidiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
...
function jsCall_viiddidiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
...
var asmLibraryArg = {
  ...
  nullFunc_viddidiiiii: nullFunc_viddidiiiii,
  nullFunc_vii: nullFunc_vii,
  nullFunc_viid: nullFunc_viid,
  nullFunc_viiddidiiiii: nullFunc_viiddidiiiii,
  ...
  jsCall_iiiid: jsCall_iiiid,
  jsCall_v: jsCall_v,
  jsCall_vi: jsCall_vi,
  jsCall_viddidiiiii: jsCall_viddidiiiii,
  jsCall_vii: jsCall_vii,
  jsCall_viid: jsCall_viid,
  jsCall_viiddidiiiii: jsCall_viiddidiiiii,
...
var dynCall_viddidiiiii = (Module['dynCall_viddidiiiii'] = function () {
  assert(
    runtimeInitialized,
    'you need to wait for the runtime to be ready (e.g. wait for main() to be called)',
  );
  ...
  return Module['asm']['dynCall_viddidiiiii'].apply(null, arguments);
});
...
var dynCall_viiddidiiiii = (Module['dynCall_viiddidiiiii'] = function () {
  assert(
    runtimeInitialized,
    'you need to wait for the runtime to be ready (e.g. wait for main() to be called)',
  );
  ...
  return Module['asm']['dynCall_viiddidiiiii'].apply(null, arguments);
});
